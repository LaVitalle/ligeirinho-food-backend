...
export class InstitutionController {
  ...
  @HateoasList({
    ...
    itemLinks: (i: InstitutionResponseDto) => ({
      self: { href: `/institutions/${i.id}`, method: "GET" },
      update: { href: `/institutions/${i.id}`, method: "PUT" },
      delete: { href: `/institutions/${i.id}`, method: "DELETE" },
    }),
  })
  async findAll(
  ...
  @HateoasItem({
    ...
    itemLinks: (i: InstitutionResponseDto) => ({
      ...
      update: { href: `/institutions/${i.id}`, method: "PUT" },
      delete: { href: `/institutions/${i.id}`, method: "DELETE" },
      canteens: { href: `/canteens?institutionId=${i.id}`, method: "GET" },
    }),
  })
